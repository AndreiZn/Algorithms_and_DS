...
def max_dot_product(first_sequence, second_sequence):
    ...
    seq_1 = np.array(first_sequence)
    seq_2 = np.array(second_sequence)
    sorted_1, sorted_2 = seq_1[np.argsort(seq_1)], seq_2[np.argsort(seq_2)]

    return np.sum(sorted_1*sorted_2)
